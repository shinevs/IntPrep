...
public class ThreeThreadSync {
	...
	public static void main(String[] args) {
		...
		ThreadId threadId = new ThreeThreadSync.ThreadId();
		threadId.setId(1);
	...
	private static Thread setThread(final Lock lock, final Condition condition, final int actualThreadId,
			final int nextThreadId, final ThreadId threadId) {
