...
/**
 * The CustomHashMap uses an array of KeyValuePair. KeyValuePair class where K
 * is the key and V value and next is the element appended to it. The
 * KeyValuePair acts as a list
 * 
 * MapList is used to store elements. the getHash() method is used to find the
 * index of the array.
 * 
 * @param <K>
 * @param <V>
